...
<table width="760" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr> 
    <td width="75%" valign="top" align="left"> 
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr> 
          <td valign="middle" align="left">当前为第 ${pager.firstRow+1} 到 ${pager.currentPage*pager.pageRows} 条记录，共${pager.totalRows}条商品信息  </td>
        </tr>
      </table>
      ...
      <table width="100%" border="0" cellspacing="2" cellpadding="2">
        <tr> 
          <td>当前为第 ${pager.firstRow+1} 到 ${pager.currentPage*pager.pageRows} 条记录，共${pager.totalRows}条商品信息 </td>
        </tr>
        <tr> 
          <td align="center"> 
            <table border="0" width="90%">
              <tr> 
                ...
                <td width="15%" align="right"> 
                  <!--是否显示最末页 -->
                   <c:if test="${pager.pageCount != 0 }">
                  <a href="subcategory.jsp?id=${subCategory.id}&currentPage=${pager.pageCount}" class="navi">未  页</a>                    
                  </c:if> 
                  <!--是否显示最末页 -->
                </td>
              </tr>
